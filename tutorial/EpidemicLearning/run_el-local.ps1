...
$defense_method = "FOOLSGOLD" # 可选值: FLAME | FOOLSGOLD | NOESISFED | AVG
...
$procs_per_machine = 16 # 每台机器的进程数 这个好像是节点数
Write-Host "Procs per machine is $procs_per_machine"
$defense_method = "AVG" # 可选值: FLAME | FOOLSGOLD | NOESISFED | AVG
...
################################ EDGE CASE Foolsgold ###############################################
# 每台机器的进程数
$attack_method = "EDGE_CASE" # 可选值：EDGE_CASE | NEUROTOXIN | MR
$attack_start = 60
$gradmask_ratio = 0.8
$malicous_nodes = 4 # 每台机器的恶意节点数量
$procs_per_machine = 16 # 每台机器的进程数 这个好像是节点数
